  ...
  <div class="gallery-viewer" :class="`gallery-viewer--${props.variant}`">
    ...
    <div class="gallery-primary">
      ...
      <template v-if="props.images.length > 1">
        <button class="gallery-arrow gallery-arrow--prev" @click.stop="prev" aria-label="Previous image">
          <i class="ph-bold ph-caret-left"></i>
        </button>
        <button class="gallery-arrow gallery-arrow--next" @click.stop="next" aria-label="Next image">
          <i class="ph-bold ph-caret-right"></i>
        </button>
        <div class="gallery-counter">{{ activeIndex + 1 }} / {{ props.images.length }}</div>
      </template>
    </div>
    ...
    <dialog ref="dialogRef" class="gallery-lightbox" @click="closeLightbox">
      <div class="gallery-lightbox-content" @click.stop>
        <button class="gallery-lightbox-close" @click="closeLightbox">&times;</button>
        <button
        ...
        <img :src="props.images[activeIndex]" :alt="props.alt" class="gallery-lightbox-img" />
        <button
          v-if="props.images.length > 1"
